...
import com.upsud.ui_imi.R.string;
...
public class CallDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		final Dialog dialog = builder.setTitle(calling?R.string.calling:R.string.incoming_call).create();
        ...
        if(calling) { callButton.setVisibility(View.GONE); }
